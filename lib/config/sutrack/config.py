...
# MODEL
cfg.MODEL = edict()
cfg.MODEL.PRETRAIN_FILE = "fast_itpn_tiny_1600e_1k.pt"
...
cfg.MODEL.ENCODER.MID_PE = False
cfg.MODEL.ENCODER.SEP_SEG = False
cfg.MODEL.ENCODER.CAT_MODE = 'direct'
cfg.MODEL.ENCODER.MERGE_LAYER = 0
cfg.MODEL.ENCODER.ADD_CLS_TOKEN = False
cfg.MODEL.ENCODER.CLS_TOKEN_USE_MODE = 'ignore'

cfg.MODEL.ENCODER.CE_LOC = []
cfg.MODEL.ENCODER.CE_KEEP_RATIO = []
cfg.MODEL.ENCODER.CE_TEMPLATE_RANGE = 'ALL'  # choose between ALL, CTR_POINT, CTR_REC, GT_BOX
